...
static kbutton_t	in_use, in_jump, in_attack, in_attack2;
...
static void IN_Attack2Down (void) {KeyDown(&in_attack2, NULL);}
static void IN_Attack2Up (void) {KeyUp(&in_attack);}
